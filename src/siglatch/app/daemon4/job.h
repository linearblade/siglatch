...
#ifndef SIGLATCH_SERVER_APP_DAEMON4_JOB_H
#define SIGLATCH_SERVER_APP_DAEMON4_JOB_H
...
typedef struct {
  ...
  int (*enqueue)(AppJobState *state, const struct M7Mux2RecvPacket *normal);
